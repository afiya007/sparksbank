...
.modal-footer>:not(:last-child) {
    ...
    <!-- slider_area_start -->
    <div class="slider_area" style="background-image: url(images/bank.jpg);">
                    ...
                    <div class="col-lg-10 col-md-10">
                        <div class="slider_text">
                            <h3 class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".1s"
                                style="color: #00bfff; margin-left: -150px;">
                            ...
                            <p class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".1s"
                                style="color:#00bfff; margin-left: -142px;">
                                <b>Managed by the cashier!</b>
                            </p>
                            <br>
                ...
                <div class="col-lg-6">
                    <div class="section_title text-center mb-70">
                        <span class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s"
                            style="font-size: 50px; color:#57b846; margin-top: -110px;" id="services"><u> SERVICES OFFERED</u></span>
                    ...
                    <div class="col-xl-4 col-md-4">
                        <div class="single_service text-center wow fadeInLeft" data-wow-duration="1.2s"
                            ...
                            <button type="button" data-toggle="modal" data-target="#myModal">
                                <div class="icon">
                                    <img src="images\c1.png" style="width:50%;height:50%;alt=" height="70px" width="70px">
                                </div>
                                <h3 style="color:red;"><b>ADD CUSTOMER</b></h3>
                                <p>Add new customers to the list with all the required details and then you are all set
                                    to transact</p>
                            </button>
                    ...
                    <div class="col-xl-4 col-md-4">
                        <div class="single_service text-center wow fadeInUp" data-wow-duration="1s"
                            ...
                            <button type="button" onclick="window.location.href='transact.php'">
                                <div class="icon">
                                    <img src="images\th.jpg"style="width:60%;height:60%; alt=" height="74px" width="74px">
                                </div>
                    ...
                    <div class="col-xl-4 col-md-4" >
                        <div class="single_service text-center wow fadeInUp" data-wow-duration="1s"
                            ...
                            <button type="button" onclick="window.location.href='view.php'">
                                <div class="icon">
                                    <img src="images\c3.jpg" style="width:50%;height:50%;alt=" height="74px" width="74px">
                                </div>
